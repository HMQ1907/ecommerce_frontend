...
const form = ref({
  ...
  permissions: defineComponentBinds('permissions', vuetifyConfig),
  permission_ids: defineComponentBinds('permissions', vuetifyConfig),
})
...
const submit = handleSubmit((values) => {
  ...
  $api.roles
    ...
    .then(() => {
      ...
      toast.success(t('roles.model.createSuccess'))
      emit('closed')
    })
    .catch((err) => {
      setErrors(err)
