...
<template>
  <v-menu bottom left>
    <template #activator="{ props }">
      <div class="tw-flex tw-items-center tw-justify-center" @click="onClick">
        <v-chip
          class="bg-primary"
          v-bind="props"
          :class="cursorClass"
          ...
          @click="onClick"
          v-text="properties.items.length"
        />
      </div>
    </template>
          ...
          <v-list-item-title class="tw-flex tw-items-center tw-gap-1">
            ...
            >
              <div class="pb-1">
                ...
                />
                <span v-else class="tw-text-white tw-text-[10px] tw-font-normal pb-2">
                  {{ item?.shortName }}
                </span>
              </div>
            </v-avatar>
