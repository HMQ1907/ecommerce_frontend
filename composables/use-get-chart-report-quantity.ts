...
export default function useGetChartReportQuantity(params?: UnwrapRef<any>, options?: any) {
  const { $api } = useNuxtApp()

  const query = useQuery(
    ['over-due-plans', params],
    () => {
      ...
      return $api.reports.getChartReportQuantity(query)
    },
    {
