...
export default function useGetProjectMembers(id: any, params?: UnwrapRef<any>, options?: any) {
  ...
  const query = useQuery(
    ...
    () => {
      ...
      return $api.projectMembers.getProjectMembers(id.value, query)
    },
    {
  ...
  const items = computed(() => query.data.value?.data.members || [])
