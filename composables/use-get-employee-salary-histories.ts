...
export default function useGetEmployeeSalaryHistories(id: number, params?: UnwrapRef<any>, options?: any) {
  const { $api } = useNuxtApp()

  const query = useQuery(
    ['employee-salary-history', params],
    () => {
      ...
      return $api.payrollConfig.getEmployeeSalary(id, query)
    },
    {
