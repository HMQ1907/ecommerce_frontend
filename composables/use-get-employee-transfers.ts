...
export default function useGetEmployees(params?: UnwrapRef<any>, options?: any) {
  const { $api } = useNuxtApp()

  const query = useQuery(
    ['employee-transfers', params],
    () => {
      ...
      return $api.employeeTransfers.getEmployeeTransfers(query)
    },
    {
