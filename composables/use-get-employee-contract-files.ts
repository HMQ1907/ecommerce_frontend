...
export default function useGetEmployeeContractFiles(id?: any, params?: UnwrapRef<any>, options?: any) {
  const { $api } = useNuxtApp()

  const query = useQuery(
    ['employee-contract-files', params],
    () => {
      ...
      return $api.employeeContracts.getEmployeeContractFiles(id.value, query)
    },
    {
