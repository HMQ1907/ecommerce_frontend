...
export default function useGetEmployeeSalaries(params?: UnwrapRef<any>, options?: any) {
  const { $api } = useNuxtApp()

  const query = useQuery(
    ['employee-salaries', params],
    () => {
      ...
      return $api.payrollConfig.getEmployeeSalaries(query)
    },
    {
