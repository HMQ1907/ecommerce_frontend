...
export default function useGetWorkPerformancesLine(params?: UnwrapRef<any>, options?: any) {
  const { $api } = useNuxtApp()

  const query = useQuery(
    ['work-performances/timelines', params],
    () => {
      ...
      return $api.reports.getPerformanceLine(query)
    },
    {
