...
export default function useGetEmployeeRetaliations(params?: UnwrapRef<any>, options?: any) {
  const { $api } = useNuxtApp()

  const query = useQuery(
    ['employee-retaliations', params],
    () => {
      ...
      return $api.employeeRetaliations.getEmployeeRetaliations(query)
    },
    {
