...
export default function useGetTemplateMembers(id?: any, params?: UnwrapRef<any>, options?: any) {
  const { $api } = useNuxtApp()

  const query = useQuery(
    ['template-members', params],
    () => {
      ...
      return $api.templateMembers.getTemplateMembers(id, query)
    },
    {
