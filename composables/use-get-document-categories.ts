...
export default function useGetDocumentCategories(params?: UnwrapRef<any>, options?: any) {
  const { $api } = useNuxtApp()

  const query = useQuery(
    ['document-categories', params],
    () => {
      ...
      return $api.documents.getDocumentCategories(query)
    },
    {
