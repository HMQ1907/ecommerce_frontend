...
export default function useGetWorkPerformancesBar(params?: UnwrapRef<any>, options?: any) {
  const { $api } = useNuxtApp()

  const query = useQuery(
    ['work-performances-warehouses', params],
    () => {
      ...
      return $api.reports.getPerformanceBar(query)
    },
    {
